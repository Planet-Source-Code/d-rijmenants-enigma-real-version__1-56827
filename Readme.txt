 ...
 This program is an exact simulation of the 3-rotor Army and the
 famous 4-rotor Naval M4 model of the German Enigma cipher machine,
 ...
 'Enigma' in the list of programs and click the Add/Remove button.
